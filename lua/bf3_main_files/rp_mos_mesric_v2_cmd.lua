...
function red_empire1()
	red_team = "red_spawner_npc_red_stormtrooper"
end
function red_rebels1()
	red_team = "red_spawner_npc_red_rebel"
end

function blu_rebels1()
	blu_team = "blu_spawner_npc_blu_rebel"
end
function blu_empire1()
	blu_team = "blu_spawner_npc_blu_stormtrooper"
end

concommand.Add("select_blu_republic1", blu_republic1)
concommand.Add("select_blu_cis1", blu_cis1)
concommand.Add("select_red_republic1", red_republic1)
concommand.Add("select_red_cis1", red_cis1)
concommand.Add("select_blu_rebels1", blu_rebels1)
concommand.Add("select_blu_empire1", blu_empire1)
concommand.Add("select_red_rebels1", red_rebels1)
concommand.Add("select_red_empire1", red_empire1)



function spawn_assets()

cmd1=ents.Create("rvb_control_point")----spawn shuttle
cmd1:SetModel("models/props_c17/oildrum001.mdl")
cmd1:SetPos(Vector( 165.62, 2286.65, 192.28 ))
cmd1:Spawn()

cmd2=ents.Create("rvb_control_point")
cmd2:SetModel("models/props_c17/oildrum001.mdl")
cmd2:SetPos(Vector( -504.18, 1565.51, 134.64 ))-----sidelot
cmd2:Spawn()

cmd3=ents.Create("rvb_control_point")
cmd3:SetModel("models/props_c17/oildrum001.mdl")
cmd3:SetPos(Vector( -977.21, 271.95, 0.28 ))----right bunker
cmd3:Spawn()

cmd4=ents.Create("rvb_control_point")
cmd4:SetModel("models/props_c17/oildrum001.mdl")
cmd4:SetPos(Vector( 61.52, -496.36, 0.28 ))------front square
cmd4:Spawn()

cmd5=ents.Create("rvb_control_point")
cmd5:SetModel("models/props_c17/oildrum001.mdl")
cmd5:SetPos(Vector( -341.81, -925.21, 128.28 )) --- trash yard
cmd5:Spawn()

cmd6=ents.Create("rvb_control_point")
cmd6:SetModel("models/props_c17/oildrum001.mdl")
cmd6:SetPos(Vector( 960.53, -13.83, 0.28 ))-----landspeeder
cmd6:Spawn()
...
repspawner1 = ents.Create(blu_team)
repspawner1:SetPos( Vector( 463.28, 1251.94, 102.03 ))
repspawner1:Spawn()

repspawner1a = ents.Create(blu_team)
repspawner1a:SetPos( Vector( 341.86, 1374.57, 109.84 ))
repspawner1a:Spawn()

repspawner1b = ents.Create(blu_team)
repspawner1b:SetPos( Vector( 328.08, 1544.45, 131.07 ))
repspawner1b:Spawn()

repspawner1c = ents.Create(blu_team)
repspawner1c:SetPos( Vector( 309.52, 1248.89, 94.15 ))
repspawner1c:Spawn()
...
repspawner2 = ents.Create(blu_team)
repspawner2:SetPos( Vector( 1751.87, 1054.56, 0.03 ))
repspawner2:Spawn()

repspawner2a = ents.Create(blu_team)
repspawner2a:SetPos( Vector( 1683.54, 1222.43, 0.03 ))
repspawner2a:Spawn()

repspawner2b = ents.Create(blu_team)
repspawner2b:SetPos( Vector( 1780.68, 919.33, 0.03 ))
repspawner2b:Spawn()

repspawner2c = ents.Create(blu_team)
repspawner2c:SetPos( Vector( 1590.89, 1129.12, 0.03 ))
repspawner2c:Spawn()




cisspawner1 = ents.Create(red_team)
cisspawner1:SetPos( Vector( -1113.16, 2020.71, 190.62 ))
cisspawner1:Spawn()

cisspawner1a = ents.Create(red_team)
cisspawner1a:SetPos( Vector( -1139.22, 1859.88, 170.5 ))
cisspawner1a:Spawn()

cisspawner2 = ents.Create(red_team)
cisspawner2:SetPos( Vector( 3461.02, 2322.65, 0.03 ))
cisspawner2:Spawn()

cisspawner2a = ents.Create(red_team)
cisspawner2a:SetPos( Vector( 3310.32, 2416.46, 0.03 ))
cisspawner2a:Spawn()



cisspawner3= ents.Create(red_team)
cisspawner3:SetPos( Vector( 2249.19, -1048.45, 0.03 ))
cisspawner3:Spawn()

cisspawner3a= ents.Create(red_team)
cisspawner3a:SetPos( Vector( 1974.44, -1107.96, 0.03 ))
cisspawner3a:Spawn()


cisspawner4= ents.Create(red_team)
cisspawner4:SetPos( Vector( -355.46, -1269.41, 3.51 ))
cisspawner4:Spawn()


cisspawner4a= ents.Create(red_team)
cisspawner4a:SetPos( Vector( -619.57, -1256.48, 9.13 ))
cisspawner4a:Spawn()

cisspawner5= ents.Create(red_team)
cisspawner5:SetPos( Vector( 3288.93, 455.8, 0.03 ))
cisspawner5:Spawn()

cisspawner6= ents.Create(red_team)
cisspawner6:SetPos( Vector( 3237.87, 302.38, 0.03 ))
cisspawner6:Spawn()

cisspawner7= ents.Create(red_team)
cisspawner7:SetPos( Vector( 3207.87, 302.38, 0.03 ))
cisspawner7:Spawn()

cisspawner8= ents.Create(red_team)
cisspawner8:SetPos( Vector( -146.2, 2354.66, 212.03 ))
cisspawner8:Spawn()

cisspawner9= ents.Create(red_team)
cisspawner9:SetPos( Vector( -67.22, 2411.95, 192.03 ))
cisspawner9:Spawn()

cisspawner10= ents.Create(red_team)
cisspawner10:SetPos(Vector( -27.22, 2471.95, 192.03 ))
cisspawner10:Spawn()

cisspawner11= ents.Create(red_team)
cisspawner11:SetPos( Vector( 2045.93, 272.33, 0.03 ))
cisspawner11:Spawn()

cisspawner12= ents.Create(red_team)
cisspawner12:SetPos( Vector( 1959.87, 251.91, 0.03 ))
cisspawner12:Spawn()

cisspawner13= ents.Create(red_team)
cisspawner13:SetPos(Vector( 2006.79, 161.72, 0.03 ))
cisspawner13:Spawn()
...
concommand.Add("spawn_assets", spawn_assets)