...
if ( key == IN_ATTACK2 ) and ply:GetModel() != "models/ryan7259/mace_windu/mace_windu_player.mdl" then
RunConsoleCommand("thirdperson_etp_offset_x",-60)
  RunConsoleCommand("thirdperson_etp_offset_y",18.56)
  RunConsoleCommand("thirdperson_etp_offset_z",0)
	end
...
hook.Add("KeyRelease", "yolo", function( player, key )
	if ( key == IN_ATTACK2 ) and player:GetModel() != "models/ryan7259/mace_windu/mace_windu_player.mdl" then
  ...
  RunConsoleCommand("thirdperson_etp_offset_y",18.56)
  RunConsoleCommand("thirdperson_etp_offset_z",0)
	elseif player:GetModel() == "models/ryan7259/mace_windu/mace_windu_player.mdl" then
