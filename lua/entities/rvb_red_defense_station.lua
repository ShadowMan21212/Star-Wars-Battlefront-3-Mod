...
function ENT:Initialize()
	...
	self.turret.Red = true
	self.turret:SetColor(Color(255,0,0,255))
	...
	self.turret2.Red = true
	self.turret2:SetColor(Color(255,0,0,255))
	...
	FlashBase:SetKeyValue('lightcolor', "255 100 0")
...
if (enemy:IsPlayer() or enemy:IsNPC()) and enemy.Blu == nil or enemy.Spec == true then

ent:AddEntityRelationship( enemy, D_LI, 99 )

end
if (enemy:IsPlayer() or enemy:IsNPC()) and enemy.Blu == true then
...
function ENT:OnTakeDamage(dmginfo)
	...
	if attacker.Red == true or attacker.Spec == true then return end
...
if((ent:IsPlayer() or ent:IsNPC()) and ent.Red == true and ent:Health() < ent:GetMaxHealth()) then
...
if IsValid(ent) then
if(ent:IsPlayer() and ent:Alive()) and ent.Red == true then
...
if(ent:IsPlayer() and ent:Alive()) and ent:Armor() < 100 and ent.Red == true then
...
self.wreck:SetColor(Color(255,0,0,255))
