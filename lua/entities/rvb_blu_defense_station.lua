...
function ENT:Initialize()
	...
	self.turret.Blu = true
	self.turret:SetColor(Color(0,0,255,255))
	...
	self.turret2.Blu = true
	self.turret2:SetColor(Color(0,0,255,255))
...
if (enemy:IsPlayer() or enemy:IsNPC()) and enemy.Red == nil or enemy.Spec == true then

ent:AddEntityRelationship( enemy, D_LI, 99 )

end
if (enemy:IsPlayer() or enemy:IsNPC()) and enemy.Red == true then
...
if((ent:IsPlayer() or ent:IsNPC()) and ent.Blu == true and ent:Health() < ent:GetMaxHealth()) then
...
if IsValid(ent) then
if(ent:IsPlayer() and ent:Alive()) and ent.Blu == true then
...
if(ent:IsPlayer() and ent:Alive()) and ent:Armor() < 100 and ent.Blu == true then
...
self.wreck:SetColor(Color(0,0,255,255))
