...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "npc_red_clone_501st_ep3_soldier" )
...
function ENT:Initialize()
	...
	self.redsoldier:SetKeyValue( "model", "models/npc/player/sono/starwars/501st_trooper.mdl" )
	...
	self.redsoldier:SetName( "npc_red_clone_501st_ep3_soldier" )
