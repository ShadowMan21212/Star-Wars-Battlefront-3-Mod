...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "npc_blu_clone_501st_ep3_soldier" )
...
function ENT:Initialize()
	...
	self.blusoldier:SetKeyValue( "model", "models/npc/player/sono/starwars/501st_trooper.mdl" ) ---models/hyperspace_network/501st_trooper_npc/501st_trooper_npc.mdl models/npc/player/sono/starwars/501st_trooper.mdl
	...
	self.blusoldier:SetName( "npc_blu_clone_501st_ep3_soldier" )
