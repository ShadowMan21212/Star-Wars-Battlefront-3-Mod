...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "npc_red_rebel_soldier" )
...
function ENT:Initialize()
	...
	self.redsoldier:SetKeyValue( "model", "models/sgg/starwars/rebels/r_soldier_forest/male_07.mdl" )
	...
	self.redsoldier:SetName( "npc_red_rebel_soldier" )
