...
util.SpriteTrail(self, 0, Color(0,120,255,255), false, 12, 0, 0.5, 0, "trails/plasma.vmt");
...
if ent.Blu == true then return end
...
ParticleEffect( "striderbuster_attach_ring", self:GetPos(), self:GetAngles(), 1 )
end
