...
self.stand:SetColor( Color(255, 0, 0, 255) )	
...
self.flag:SetCollisionGroup(COLLISION_GROUP_WEAPON)
...
self.flag2:SetColor( Color(255, 0, 0, 255) )	
...
util.SpriteTrail(self.flag2, 0, Color(255,0,0,255), false, 25, 0, 0.5, 0, "trails/physbeam.vmt")

end

function ENT:Touch(activator)
if (activator:IsPlayer() or activator:IsNPC()) and activator.Blu == true and self.Stolen == nil then
...
elseif (activator.BluFlag == true and self.Stolen == nil) and activator.Stolen == true then 
...
v:PrintMessage( HUD_PRINTCENTER, "BLU" .. " " .. activator.OurPoints .. ":" .. self.OurPoints .. " " .. "RED" )
v:ConCommand("play buttons/button19.wav")
end
end
end
...
for k,v in pairs (ents.GetAll()) do
if v.BluFlag == true and self.OurPoints >= self.PointsLimit then
v.OurPoints = 0
